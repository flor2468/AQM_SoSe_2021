...
def test_function_pleasure():
    ...
    # print(len(frequently_book))
    # print(len(pleasure_book))
    # print(len(pleasure_movie))
    # print()
    ...
    pleasure_movie_56 = 0
    pleasure_movie_78 = 0
    pleasure_movie_910 = 0
    never_movie = []

    for i in range(len(frequently_book)):
        # print(frequently_book[i])
        # print(pleasure_book[i])
        # print(pleasure_movie[i])
        # print()

        if frequently_book[i] == 'never':
            # print(pleasure_book[i])
            # print(pleasure_movie[i])
            if pleasure_book[i] == '1' or pleasure_book[i] == '2':
                pleasure_book_12 += 1
            if pleasure_book[i] == '3' or pleasure_book[i] == '4':
                pleasure_book_34 += 1
            if pleasure_book[i] == '5' or pleasure_book[i] == '6':
                pleasure_book_56 += 1
            if pleasure_book[i] == '7' or pleasure_book[i] == '8':
                pleasure_book_78 += 1
            if pleasure_book[i] == '9' or pleasure_book[i] == '10':
                pleasure_book_910 += 1

            if pleasure_movie[i] == '1' or pleasure_movie[i] == '2':
                pleasure_movie_12 += 1
            if pleasure_movie[i] == '3' or pleasure_movie[i] == '4':
                pleasure_movie_34 += 1
            if pleasure_movie[i] == '5' or pleasure_movie[i] == '6':
                pleasure_movie_56 += 1
            if pleasure_movie[i] == '7' or pleasure_movie[i] == '8':
                pleasure_movie_78 += 1
            if pleasure_movie[i] == '9' or pleasure_movie[i] == '10':
                pleasure_movie_910 += 1

    never_book.append(pleasure_book_12)
    never_book.append(pleasure_book_34)
    never_book.append(pleasure_book_56)
    never_book.append(pleasure_book_78)
    never_book.append(pleasure_book_910)

    never_movie.append(pleasure_movie_12)
    never_movie.append(pleasure_movie_34)
    never_movie.append(pleasure_movie_56)
    never_movie.append(pleasure_movie_78)
    never_movie.append(pleasure_movie_910)
    ...
    seldom_book.append(pleasure_book_12)
    seldom_book.append(pleasure_book_34)
    seldom_book.append(pleasure_book_56)
    seldom_book.append(pleasure_book_78)
    seldom_book.append(pleasure_book_910)

    seldom_movie.append(pleasure_movie_12)
    seldom_movie.append(pleasure_movie_34)
    seldom_movie.append(pleasure_movie_56)
    seldom_movie.append(pleasure_movie_78)
    seldom_movie.append(pleasure_movie_910)
    ...
    sometimes_book.append(pleasure_book_12)
    sometimes_book.append(pleasure_book_34)
    sometimes_book.append(pleasure_book_56)
    sometimes_book.append(pleasure_book_78)
    sometimes_book.append(pleasure_book_910)

    sometimes_movie.append(pleasure_movie_12)
    sometimes_movie.append(pleasure_movie_34)
    sometimes_movie.append(pleasure_movie_56)
    sometimes_movie.append(pleasure_movie_78)
    sometimes_movie.append(pleasure_movie_910)
    ...
    often_book.append(pleasure_book_12)
    often_book.append(pleasure_book_34)
    often_book.append(pleasure_book_56)
    often_book.append(pleasure_book_78)
    often_book.append(pleasure_book_910)

    often_movie.append(pleasure_movie_12)
    often_movie.append(pleasure_movie_34)
    often_movie.append(pleasure_movie_56)
    often_movie.append(pleasure_movie_78)
    often_movie.append(pleasure_movie_910)
    ...
    very_often_book.append(pleasure_book_12)
    very_often_book.append(pleasure_book_34)
    very_often_book.append(pleasure_book_56)
    very_often_book.append(pleasure_book_78)
    very_often_book.append(pleasure_book_910)

    very_often_movie.append(pleasure_movie_12)
    very_often_movie.append(pleasure_movie_34)
    very_often_movie.append(pleasure_movie_56)
    very_often_movie.append(pleasure_movie_78)
    very_often_movie.append(pleasure_movie_910)


    # print()
    # print(pleasure_book_12)
    # print(pleasure_book_34)
    # print(pleasure_book_56)
    # print(pleasure_book_78)
    # print(pleasure_book_910)
    # print(never_book)
    # print(never_movie)
    # print(seldom_book)
    # print(seldom_movie)
...
def test_function_2_pleasure():

    never_sum, seldom_sum, sometimes_sum, often_sum, very_often_sum = get_frequency_dispersion()
    never_book, never_movie, seldom_book, seldom_movie, sometimes_book, sometimes_movie, often_book, often_movie, very_often_book, very_often_movie = test_function_pleasure()
